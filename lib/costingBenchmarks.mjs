 ...
 * @typedef {{ ingredient: string | null, master_id: string | null, vendor: string | null, pack_price: number | null, pack_size: number | null, pack_unit: string | null, id: number }} VendorPriceRow
 ...
 * @param {{vendor: string | null, pack_price: number | null, pack_size: number | null, pack_unit?: string | null} | null | undefined} r
 * @returns {r is {vendor: string | null, pack_price: number, pack_size: number, pack_unit?: string | null}}
 */
...
export function resolveMergedCost(rows, preferredVendor) {
  ...
  const meanUnitCost = latest.reduce((s, r) => s + r.pack_price / r.pack_size, 0) / n;
...
export function computeCostVariance(db, locationId, opts = {}) {
  ...
  const vpRows = /** @type {VendorPriceRow[]} */ (
    db
      .prepare(
        `SELECT ingredient, master_id, vendor, pack_price, pack_size, pack_unit, id
           FROM vendor_prices
          WHERE location_id = ?
