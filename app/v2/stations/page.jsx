    ...
    <main style={{ display: 'grid', gap: 18 }}>
      <section style={heroStyle}>
        <div style={{ display: 'grid', gap: 8 }}>
          <div style={eyebrowStyle}>Station boards</div>
          <h1 style={titleStyle}>Open a board</h1>
          <p style={copyStyle}>Jump into line checks fast and keep each station moving.</p>
        </div>
