...
| **Native 0.2.x** | **L1 in-process BOM** — BomExpand + BeoCascade in Swift, native spawn removal | **Code-complete on `main` (PR #448)** — automated verify-0.2 green 2026-07-10; owner GUI smoke = Front 0 Part A (`plans/2026-08-05-g0-gui-smoke-and-shutoff.md`) |
| **Native 1.0.x** | Service-day shutoff, schema ownership flip (C4/C5), thin web edge | Blocked on G0, C4, C5, H8 — execution index: `plans/2026-08-05-native-1-0-gap-execution-index.md` |
