...
> and Native 0.2 L1 D1 (Application Support recipe root). This Electron+Next hub design remains
> reference only if a separate LAN-supervisor wrapper is revived — not the Native 0.2 L1 path.
